...
export function LoadFromFile(): ReactNode {
  ...
  return (
    <HomeCard title="Load from file">
      <Text>
        Supports official Prosperity log downloads as well as legacy visualizer logs generated by a compatible local
        logger. If the file does not parse, check whether it is a real submission log or a plain console dump.
      </Text>
