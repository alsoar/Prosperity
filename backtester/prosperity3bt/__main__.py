...
def monte_carlo_cli(
    ...
    data: Annotated[Optional[Path], Option(help="Path to round-1 data directory. If it contains round1/, that round1 directory is used as the calibration source.", show_default=False, exists=True, file_okay=False, dir_okay=True, resolve_path=True)] = None,
